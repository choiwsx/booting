package org.kitchen.booting.event.listener;
/*
...
import org.kitchen.booting.exception.MailSendException;
import org.kitchen.booting.service.userauth.EmailVerificationTokenService;
import org.kitchen.booting.service.userauth.MailService;
...
public class NewUserEventListener implements ApplicationListener<NewUserEvent> {
    ...
    private static final Logger logger = Logger.getLogger(NewUserEventListener.class);
    private final EmailVerificationTokenService emailVerificationTokenService;
    private final MailService mailService;

    @Autowired
    public NewUserEventListener(EmailVerificationTokenService emailVerificationTokenService, MailService mailService) {
    ...
    public void onApplicationEvent(NewUserEvent newUserEvent) {
        sendEmailVerification(newUserEvent);
    }

    /**
     * Send email verification to the user and persist the token in the database.
     */
    private void sendEmailVerification(NewUserEvent event) {
